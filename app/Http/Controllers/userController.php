...
{
    public function index_is_Block()
    {
    ...
    public function index_all_Block()
    {
        $users = User::where('role_name', 'admin_hall')->where('is_block', '1')->get();
    ...
    public function index()
    {
        ...
        if (Auth::user()->role_name == 'super_admin') {
            return $this->sendResponse([$users], 'user data retrivied successfully');
        } else {
