...
class ReservationController extends BaseController
{
    public function index()
    {
        ...
        $reservations = Reservation::with('user', 'hall', 'decoration', 'payment', 'photography', 'foodRequest', 'songRequest')
            ->get();
    ...
    public function addReservation(Request $request)
    {
        ...
        $hallReservation = Reservation::where('hall_id', '=', $hall_id)
            ->where('date', '=', $date)
            ->first();
        ...
        $photographyReservation = Reservation::where('photography_id', '=', $photography_id)
            ->where('date', '=', $date)
            ->first();
        ...
        $myReservation = Reservation::with('user', 'hall', 'decoration', 'payment', 'photography', 'foodRequest', 'songRequest')
